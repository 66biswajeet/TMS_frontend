...
//   // --- FETCH DATA (EXACT SAME AS ORIGINAL) ---
...
//   // Initial load for filter options (EXACT SAME AS ORIGINAL)
//   useEffect(() => {
...
//   // Initial data load and data re-load on filter change (EXACT SAME AS ORIGINAL)
//   useEffect(() => {
...
//               {loading ? (
//                 <tr>
//                   <td colSpan={7} className="text-center py-12 text-indigo-600">
